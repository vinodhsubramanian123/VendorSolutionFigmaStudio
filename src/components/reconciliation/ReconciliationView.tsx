        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 animate-fadeIn">
          ...
          <div className="lg:col-span-4 bg-[#0a101f] border border-white/5 p-4 rounded-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9.5px] bg-[#ff3d5a]/10 text-status-error border border-[#ff3d5a]/20 px-1.5 py-0.5 rounded font-black uppercase font-mono animate-pulse">
                    Sourcing Warnings
                  </span>
                </div>
            ...
            <div className="flex items-center gap-2.5 w-full md:w-auto shrink-0 pt-2 md:pt-0 border-t md:border-transparent border-white/5">
              <button
                onClick={() => {
                  toast.toast(
                    "Reconciliation committed successfully! UCID status set to locked sync.",
                    "success",
                  );
                  setHasDrift(false);
                }}
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* Card 1 */}
              <div className="bg-surface-elevated/90 border border-white/5 hover:border-indigo-500/30 rounded-xl p-4 flex flex-col justify-between transition-all duration-200">
                  ...
                  <div className="flex gap-2.5">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[9px] bg-orange-500/10 text-orange-400 border border-orange-500/20 px-1 rounded uppercase font-bold">
                          1 spares
                        </span>
                      </div>
                      <h4 className="font-bold text-white text-xs mt-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1.5 font-mono text-[10.5px] text-gray-400">
                ...
                <span className="text-indigo-300 font-bold">
                  {selectedConfigSheet}: Core Compute Servers
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-4">
            <div className="text-left">
              <div className="flex items-center gap-2">
                ...
                <StatusBadge status="UCID-2026-0042 - Solution A" variant="info" />
              </div>
              <p className="text-[11px] text-gray-500 mt-1">
                BOQ vs Validated BOM Configuration — 11 line items across 6
                component groups
              </p>
            </div>
