    ...
    <div className="lg:col-span-3 flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2 px-3 py-2 rounded-lg border bg-surface-canvas/20 border-white/5">
        ...
        <input
          ...
          className="flex-1 bg-transparent text-xs text-content-primary placeholder-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50"
        />
        {searchTerm && (
          <button type="button" onClick={() => setSearchTerm("")} className="text-content-muted hover:text-content-secondary">
              ...
              <motion.div
                ...
                className={`rounded-lg border transition-all cursor-pointer ${
                  isSelected
                    ...
                    : "border-white/5 bg-surface-canvas/15 hover:border-white/10"
                }`}
                onClick={() => {
                ...
                <div className="flex items-start gap-3 p-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap mb-0.5">
                      ...
                      {entry.vendor && (
                        <span className="text-[9px] text-content-primary0">{entry.vendor}</span>
                      )}
                    </div>

                    {entry.matchedPartNumber && (
                      <div className="flex items-center gap-1.5 text-[10px] text-content-secondary mt-0.5">
                  ...
                  <div className="shrink-0 text-right">
                    <p className="text-[9px] text-content-muted font-mono mb-1">{entry.confidence}%</p>
