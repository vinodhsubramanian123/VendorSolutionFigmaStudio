...
export function SourcingReconciliationDiff({
  ...
  return (
    <div className="bg-surface-card border border-indigo-500/15 rounded-xl p-4 space-y-3.5 shadow-2xl">
            ...
            {types.map((type) => {
              ...
              return (
                <tr key={type} className="hover:bg-white/5">
                  {/* Category */}
                  <td className="py-2.5 font-bold text-gray-400 font-mono text-[9px] uppercase tracking-wide">
                    {type}
                  </td>
                  ...
                  <td className="py-2.5 font-mono text-right font-bold text-[10px] whitespace-nowrap">
                    {itemA && itemB ? (
                      diff === 0 ? (
                        <span className="text-gray-500 bg-white/5 px-1.5 py-0.5 rounded text-[8.5px]">
                          PARITY
                        </span>
                      ) : diff < 0 ? (
