          ...
          <div className="flex items-center gap-3 w-full">
            ...
            <div className="flex-1">
              ...
              <p className="text-[10px] text-gray-400 mt-0.5 leading-relaxed">
                The single source of truth for all external spreadsheets. Upload
                raw Bills of Quantities or Technical Bills of Materials and get
                real-time contract audits.
              </p>
            </div>
