...
import { X, AlertTriangle, Link2, CheckCircle2, Search, ArrowRight, Eye } from "lucide-react";
import type { CatalogSKU } from "../../types";
import type { CleansingEntry } from "./types";
...
export function MappingPanel({
  ...
  const statusCfg = STATUS_CONFIG[selectedEntry.matchStatus];
