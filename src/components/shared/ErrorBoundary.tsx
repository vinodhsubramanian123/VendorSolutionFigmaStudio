...
export class ErrorBoundary extends React.Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center p-8 text-center bg-surface-elevated rounded-xl border border-red-500/20 shadow-lg min-h-[400px]">
          ...
          <div className="mb-8 rounded-md bg-surface-canvas p-4 text-xs font-mono text-gray-400 text-left w-full max-w-2xl overflow-auto border border-gray-800 h-32">
            {this.state.errorMsg}
          </div>
