        ...
        <div className="bg-surface-elevated border border-white/5 rounded-xl p-6 space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            ...
            <div className="flex flex-col items-start sm:items-end gap-1 shrink-0 w-full sm:w-64">
              ...
              >
                <option value="hpe-legacy" className="bg-surface-elevated text-content-primary">HPE Legacy 6130 EOL</option>
                <option value="dell-overcharge" className="bg-surface-elevated text-content-primary">Dell Premier Markup</option>
                <option value="cisco-asymmetry" className="bg-surface-elevated text-content-primary">Cisco Asymmetry Layout</option>
              </Select>
            </div>
          </div>
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-300 relative overflow-hidden bg-surface-canvas/10 hover:bg-surface-canvas/20 hover:border-sky-500/30 ${
          ...
          >
            ...
            {isBOQIngesting ? (
              ...
              <div className="space-y-3 flex flex-col items-center">
                <div className="w-10 h-10 rounded-full bg-status-success/10 border border-status-success/20 text-status-success flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-content-secondary mt-1 font-mono">
                    UCID session created:{" "}
                    <strong className="text-content-primary">{getUcidDisplayRef(boqResponse.ucid)}</strong>
                  </p>
                </div>
              </div>
            ) : (
            ...
            {boqResponse && (
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-[9px] text-status-success font-medium">
                              calculated sav. $
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  className="px-5 py-2.5 rounded-lg bg-sky-500 hover:bg-sky-600 text-content-primary font-bold cursor-pointer transition flex items-center gap-2 shadow-lg shadow-sky-500/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50 text-[11px]"
                >
