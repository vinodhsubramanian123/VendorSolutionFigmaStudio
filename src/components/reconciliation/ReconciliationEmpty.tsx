...
export function ReconciliationEmpty() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] border border-dashed border-status-success/20 bg-surface-canvas/10 rounded-xl m-6 p-12 text-center animate-fadeIn">
