...
import { CATALOG_TREND, UCID_STEPS } from "../../lib/mockData";
        ...
        {KPI_CARDS.map((kpi, i) => {
          ...
          return (
            <button
              ...
              style={{
                background:
                  hovered === `kpi-${i}` ? "rgba(74,133,253,0.08)" : "#0b1220",
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span
                  ...
                  style={{ color: kpi.up ? "#00d4a0" : "#ff3d5a" }}
                >
                  {kpi.up ? (
        ...
        >
          ...
          >
            {areaChart.dimensions.width > 0 ? (
              <AreaChart
                width={areaChart.dimensions.width}
                height={areaChart.dimensions.height}
                data={CATALOG_TREND}
        ...
        >
          ...
          >
            {pieChart.dimensions.width > 0 ? (
              <PieChart
                width={pieChart.dimensions.width}
                height={pieChart.dimensions.height}
              >
                <Pie
                  key="pie"
                  data={VENDOR_PIE}
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div
              ...
              style={{ borderColor: "rgba(74,133,253,0.06)" }}
            >
              {forensicIssues.filter((f) => f.status !== "resolved").length ===
              0 ? (
