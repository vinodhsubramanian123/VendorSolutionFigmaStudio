...
interface TaxonomyTreeProps {
  ...
  vendors?: any[];
  onSetToast: (toast: { message: string; type: 'success' | 'warn' | 'error' } | null) => void;
}
  ...
  return (
    <div className="flex-1 select-none scrollbar-thin overflow-y-auto pr-0.5 min-h-0 space-y-1 text-[11px]">
          ...
          >
            ...
            >
              ...
              <span className="font-mono text-[9px] bg-black/40 px-1.5 py-0.5 rounded text-emerald-400 font-bold border border-emerald-500/10">
                {vendors?.find(v => v.shortName === 'HPE')?.catalogItems?.toLocaleString() || '5,812'}
              </span>
            </button>
            <button 
            ...
            <div className="pl-3.5 border-l border-white/5 ml-3 pb-1 space-y-1">
              ...
              <div className="space-y-0.5">
                <div className="flex items-center justify-between px-1.5 py-1 rounded hover:bg-white/1">
                  ...
                  <button onClick={() => onToggleNode('hpe_Server')} className="text-gray-500 hover:text-white">
                        ...
                        <div className="pl-3 border-l border-white/5 ml-2 space-y-1 text-[10px]">
                          ...
                          <div className="space-y-0.5">
                            <div className="flex items-center justify-between py-0.5 px-1 rounded hover:bg-white/1">
                              ...
                              <button 
                                onClick={() => onToggleNode('hpe_Server_DL380_Gen11')} 
                          ...
                          <div className="space-y-0.5">
                            <div className="flex items-center justify-between py-0.5 px-1 rounded hover:bg-white/1">
                              ...
                              <button 
                                onClick={() => onToggleNode('hpe_Server_DL380a_Gen11')} 
                          ...
                          <div className="space-y-0.5">
                            <div className="flex items-center justify-between py-0.5 px-1 rounded hover:bg-white/1">
                              ...
                              <button 
                                onClick={() => onToggleNode('hpe_Server_DL380_Gen12')} 
                                className="text-gray-655 hover:text-white"
                              >
                          ...
                          <div className="space-y-0.5">
                            <div className="flex items-center justify-between py-0.5 px-1 rounded hover:bg-white/1">
                              ...
                              <button 
                                onClick={() => onToggleNode('hpe_Server_DL380_Gen13')} 
                                className="text-gray-650 hover:text-white"
                              >
              ...
              <div className="space-y-0.5">
                <div className="flex items-center justify-between px-1.5 py-1 rounded hover:bg-white/1">
                  ...
                  <button onClick={() => onToggleNode('hpe_Storage')} className="text-gray-500 hover:text-white">
              ...
              <div className="space-y-0.5">
                <div className="flex items-center justify-between px-1.5 py-1 rounded hover:bg-white/1">
                  ...
                  <button onClick={() => onToggleNode('hpe_Networking')} className="text-gray-500 hover:text-white">
          ...
          >
            ...
            >
              ...
              <span className="font-mono text-[9px] bg-black/40 px-1.5 py-0.5 rounded text-purple-400 font-bold border border-purple-500/10">
                {vendors?.find(v => v.shortName === 'Cisco')?.catalogItems?.toLocaleString() || '3,104'}
              </span>
            </button>
            <button 
          ...
          >
            ...
            >
              ...
              <span className="font-mono text-[9px] bg-black/40 px-1.5 py-0.5 rounded text-sky-400 font-bold border border-sky-500/10">
                {vendors?.find(v => v.shortName === 'Dell')?.catalogItems?.toLocaleString() || '4,831'}
              </span>
            </button>
            <button 
          ...
          >
            ...
            >
              ...
              <span className="font-mono text-[9px] bg-black/40 px-1.5 py-0.5 rounded text-emerald-100 font-bold border border-emerald-500/10">
                {vendors?.find(v => v.shortName === 'Juniper')?.catalogItems?.toLocaleString() || '1,420'}
              </span>
            </button>
            <button 
      ...
      <div className="p-3 bg-black/30 border border-white/5 rounded-lg space-y-2 pt-2.5">
        <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider block text-left">Bulk Taxonomy Ingest</span>
        ...
        <button 
          type="button" 
          onClick={() => onSetToast({ message: "Ready. Drop your workbook files directly inside the Solution Architecture Builder's intake drawer.", type: "success" })}
