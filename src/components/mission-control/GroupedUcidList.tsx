...
export function GroupedUcidList({
  ...
  return (
    <div className="pr-1 space-y-4">
      {Object.entries(filteredGroupedUcids).map(([solutionGroup, groupItems], groupIdx) => {
        return (
          <motion.div
            key={solutionGroup}
          ...
          >
            ...
            <div className="space-y-2 pl-0.5 relative">
              <AnimatePresence>
                {groupItems.map((u) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="w-full text-left p-3 rounded-lg border transition-colors duration-200 block cursor-pointer relative group focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50 focus:ring-1 focus:ring-indigo-500"
                      style={{
