    ...
    >
      ...
      <div className="mt-2.5 border-t border-white/5 pt-2 flex flex-col gap-2">
        <button
          ...
          className="flex items-center gap-1 self-start px-2 py-0.5 bg-white/5 hover:bg-white/10 rounded text-gray-400 hover:text-white font-mono text-[8.5px] transition cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50"
        >
          {isExpanded ? (
            <>
