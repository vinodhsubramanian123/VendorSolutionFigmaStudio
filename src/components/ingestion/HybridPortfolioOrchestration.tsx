    ...
    <div className="space-y-6 animate-fadeIn text-left select-none">
      ...
      <div className="bg-surface-elevated border border-indigo-500/10 rounded-xl p-6 relative overflow-hidden text-left">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-5 border-t border-white/5 text-white text-left">
          ...
          <div className="p-3 bg-black/20 rounded border border-white/5 text-left">
            <p className="text-[9px] text-gray-400 uppercase font-mono font-bold tracking-wider">
              Manual Channel Link
            </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-left">
        ...
        <div className="bg-surface-elevated border border-white/5 rounded-xl p-5 space-y-4 flex flex-col justify-between text-left">
          <div className="space-y-3 font-sans text-left">
            <div className="flex justify-between items-start text-left">
              <div>
                ...
                <h3 className="text-xs font-bold text-white mt-1.5 font-mono">
                  UCID-2026-1701
                </h3>
                <p className="text-[10px] text-gray-400">
                  Dell Symmetrical Edge Compute
                </p>
              </div>
            ...
            <div className="p-3 rounded bg-black/10 border border-white/[0.03] space-y-2 text-left font-mono">
              <p className="text-[9px] text-gray-400 uppercase block font-mono">
                Segregated Custom Config Slots (1701-Umbrella)
              </p>
              <div className="space-y-1.5 pt-1 text-[10px]">
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Slot 1: Tygor R760 Server Node
                  </span>
                  {manualBOMStatus !== "pending" ? (
                    ...
                    <span className="text-gray-500 uppercase text-[8px]">
                      Awaiting file
                    </span>
                  )}
                </div>
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Slot 2: Xeon Core Processor Array
                  </span>
                  {manualBOMStatus !== "pending" ? (
                    <span className="text-emerald-400 font-bold uppercase text-[8px]">
                      Synced
                ...
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Slot 3: Symmetrical RDIMM Layout
                  </span>
                ...
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Slot 4: Master Solid-State NVMe
                  </span>
                  {manualBOMStatus === "complete" ? (
                    <span className="text-emerald-400 font-bold uppercase text-[8px]">
                      Synced
          ...
          <div className="pt-4 border-t border-white/5 space-y-3 text-left">
            <p className="text-[10px] text-gray-400 font-medium leading-relaxed">
              Select one of the simulated manufacturer portal quote workbooks to
              simulate manual drops for UCID-2026-1701:
            </p>
            ...
            {manualUploadedFiles.length > 0 && (
              <div className="p-2.5 rounded bg-black/30 border border-white/5 space-y-1 text-left select-text">
                <p className="text-[8px] text-gray-500 uppercase font-mono block">
                  Ingested Source Documents:
                </p>
                {manualUploadedFiles.map((f, i) => (
                  <p
                    key={i}
                    className="text-[9px] text-gray-300 font-mono truncate"
                  >
                    📄 {f}
                  </p>
                ))}
        ...
        <div className="bg-surface-elevated border border-white/5 rounded-xl p-5 space-y-4 flex flex-col justify-between text-left">
          <div className="space-y-3 font-sans text-left">
            <div className="flex justify-between items-start text-left">
              <div>
                <span className="text-[8px] bg-sky-500/10 text-sky-400 border border-sky-500/20 px-2 py-0.5 rounded font-black tracking-wide uppercase flex items-center gap-1 w-max inline-block">
                  <span
                    className={`w-1 h-1 rounded-full ${hpeSyncedConfigs === 4 ? "bg-emerald-400" : "bg-sky-400 animate-ping"} inline-block`}
                  />
                  <span>
                    {hpeSyncedConfigs === 4
                      ? "Status: Synced"
            ...
            <div className="p-3 rounded bg-black/10 border border-white/[0.03] space-y-2 text-left font-mono">
              <p className="text-[9px] text-gray-400 uppercase block">
                Sequential Execution Line (1702)
              </p>
              <div className="space-y-1.5 pt-1 text-[10px]">
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Config 1: HPE ProLiant Gen11 Chassis
                  </span>
                  {hpeSyncedConfigs >= 1 ? (
                    <span className="text-emerald-400 font-bold uppercase text-[8px]">
                      Synced
                ...
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Config 2: Intel Xeon Scalable High CPU
                  </span>
                  {hpeSyncedConfigs >= 2 ? (
                    <span className="text-emerald-400 font-bold uppercase text-[8px]">
                      Synced
                ...
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Config 3: Symmetrical Memory Sourcing
                  </span>
                  {hpeSyncedConfigs >= 3 ? (
                    <span className="text-emerald-400 font-bold uppercase text-[8px]">
                      Synced
                ...
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Config 4: Redundant Power Grid Bus
                  </span>
                  {hpeSyncedConfigs >= 4 ? (
                    <span className="text-emerald-400 font-bold uppercase text-[8px]">
                      Synced
          ...
          <div className="space-y-3 text-left">
            <div className="flex justify-between items-start text-left">
              <div>
                <span className="text-[8px] bg-sky-500/10 text-sky-400 border border-sky-500/20 px-2 py-0.5 rounded font-black tracking-wide uppercase flex items-center gap-1 w-max inline-block">
                  <span
                    className={`w-1 h-1 rounded-full ${ciscoSyncedConfigs === 4 ? "bg-emerald-400" : "bg-sky-400 animate-ping"} inline-block`}
                  />
                  <span>
                    {ciscoSyncedConfigs === 4
                      ? "Status: Synced"
                      : ciscoSyncedConfigs > 0
                        ? "Status: Bot Syncing"
                        : "Status: Idle"}
                  </span>
                </span>
                <h3 className="text-xs font-bold text-white mt-1.5 font-mono font-bold">
                  UCID-2026-1703
                </h3>
                <p className="text-[10px] text-gray-400">
                  Cisco Symmetrical Fabric
                </p>
              </div>
              <div className="text-right font-mono">
                <p className="text-xs font-bold text-white">
                  ${(ciscoSyncedConfigs * 90750).toLocaleString()}
                </p>
            ...
            <div className="p-3 rounded bg-black/10 border border-white/[0.03] space-y-2 text-left font-mono">
              <p className="text-[9px] text-gray-400 uppercase block font-mono">
                Sequential Execution Line (1703)
              </p>
              <div className="space-y-1.5 pt-1 text-[10px]">
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Config 1: Cisco UCS Rack Frame
                  </span>
                ...
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Config 2: Intel Symmetrical Core Xeon
                  </span>
                ...
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Config 3: Virtual Interface Fabrics (VIC)
                  </span>
                ...
                <div className="flex items-center justify-between p-1.5 rounded bg-surface-card border border-white/5">
                  <span className="text-gray-300">
                    Config 4: Symmetrical Power Ingress Grid
                  </span>
                  {ciscoSyncedConfigs >= 4 ? (
                    <span className="text-emerald-400 font-bold uppercase text-[8px]">
                      Synced
            ...
            <tbody className="divide-y divide-white/[0.03]">
                ...
                <td className="py-3">
                  {manualBOMStatus === "complete" ? (
                    <span className="text-emerald-400 font-medium">
                      All 4 structural hardware components mapped and validated
                    </span>
                  ) : manualBOMStatus === "partial" ? (
                    <span>
                      2 of 4 hardware components mapped from partial spreadsheet
                      drop
                    </span>
                  ) : (
              ...
              <tr className="hover:bg-white/[0.01] transition-all text-left">
                ...
                <td className="py-3">
                  {hpeSyncedConfigs === 4 ? (
                    <span className="text-emerald-400 font-medium">
                      All 4 catalog configurations tracked, aligned and verified
                    </span>
                  ) : (
                    <span>
                      {hpeSyncedConfigs} of 4 configurations synced in sequence
                    </span>
                  )}
                </td>
                <td className="py-3 text-right font-mono font-bold text-white">
              ...
              <tr className="hover:bg-white/[0.01] transition-all text-left">
                ...
                <td className="py-3">
                  {ciscoSyncedConfigs === 4 ? (
                    ...
                    <span>
                      {ciscoSyncedConfigs} of 4 configurations synced in
                      sequence
                    </span>
                  )}
                </td>
        ...
        <div className="bg-surface-card border border-white/5 p-4 rounded-lg space-y-2 mt-2 text-left">
          ...
          <p className="text-gray-400 text-[10px] leading-relaxed text-left">
            ...
            ciscoSyncedConfigs === 4 ? (
              ...
              ciscoSyncedConfigs === 4 ? (
              <span>
                ⚠ <strong>Partial Ledger Alignment</strong>: Automated parallel
                crawls completed successfully. Manual tracking UCID-1701 matched{" "}
                <strong>Configs 1 & 2</strong> ($196,200), leaving{" "}
                <strong>Configs 3 & 4</strong> marked as outstanding. Complete
                comparison results will re-calculate instantly upon final manual
                drop!
              </span>
            ) : isPortfolioActive ? (
              <span>
                ⚙ <strong>Active Orchestration Pipeline</strong>: HPEMarketplace
                and DellPremierPortal crawlers are updating configuration
                streams. Offline operator uploads can be performed concurrently
                for UCID-1701.
              </span>
            ) : (
              <span>
                💡 Start the hybrid pipeline to test parallel automated bots
                alongside custom manual upload streams.
              </span>
            )}
          </p>
        </div>
